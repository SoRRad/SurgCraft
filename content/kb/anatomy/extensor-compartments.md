...
| # | Tendons | Landmark |
|---|---------|----------|
| 1 | APL, EPB | Radial styloid; de Quervain's territory |
| 2 | ECRL, ECRB | Radial dorsum; Lister's tubercle radial side |
| 3 | EPL | Ulnar to Lister's tubercle (EPL rupture risk in distal radius fx) |
| 4 | EIP, EDC | Central dorsum; 4 EDC slips + EIP |
