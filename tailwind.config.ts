...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        display: ["clamp(2.25rem, 6vw, 4rem)", { lineHeight: "1.05" }],
        h1: ["clamp(2rem, 4vw, 3.25rem)", { lineHeight: "1.15" }],
        h2: ["clamp(1.5rem, 3vw, 2.25rem)", { lineHeight: "1.22" }],
        h3: ["clamp(1.125rem, 2vw, 1.5rem)", { lineHeight: "1.3" }],
        stem: ["clamp(1.125rem, 2.6vw, 1.5rem)", { lineHeight: "1.5" }],
