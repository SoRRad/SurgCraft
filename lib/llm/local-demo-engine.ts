...
export const TUTOR_ANSWERS: TutorAnswer[] = [
  ...
  },
  {
    ...
    roundsOneLiner: "Mallet finger, small fragment, congruent joint: DIP extension splint full-time × 6 weeks — PIP free, clock restarts if DIP flexes once.",
